...
# #turn on oscilator 
# bus.writeto(ht16k33_i2c_address, [0x21])
# #enable display (no blinking mode)
# bus.writeto(ht16k33_i2c_address, [0x81])
# #clear dispay 
# bus.writeto(ht16k33_i2c_address, [0x00] + [0x00] * 16)
# #set brightness 0-15
# bus.writeto(ht16k33_i2c_address, [HT16K33_CMD_BRIGHTNESS | 15] )
#         #grafic buffer 
# buffer = [0xff for x in range(0, 16)]
# bus.writeto(ht16k33_i2c_address, [0x00] + buffer)
...
class HT16K33():
    ...
    def read_key_data(self):
        ...
        key_buffer = bytearray(1)
        self.bus.readfrom_into(self.ht16k33_i2c_address, key_buffer,  start=0x45, end=0x46)
        #  does not work  from 3.3 
    ...
    def update(self):
        self.bus.writeto(self.ht16k33_i2c_address, [0x00] + self.buffer)
